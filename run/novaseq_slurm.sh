...
## module purge 
## module load ...
## module load miniconda module

WORKDIR=/PATH/TO/open-arms;
TMPDIR=/PATH/TO/TEMP_DIR;
SANDBOX="$TMPDIR/temparms-sandbox"

apptainer exec --bind "$WORKDIR":/work --bind "$TMPDIR/conda_envs":/envs --bind /ABSOLUTE/PATH/TO/SYMLINKED/FILES/SOURCE:/ABSOLUTE/PATH/TO/SYMLINKED/FILES/SOURCE "$SANDBOX" bash /work/run/novaseq_run.sh
